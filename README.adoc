...
For these credentials to be used, you will either need to set the environment
(like `export AWS_PROFILE=minecraft`) or, if you prefer, you can change the
section to `[default]` if you'd like to use them automatically for all AWS
interactions.
